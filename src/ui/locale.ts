...
export const LOCALE_UI: Record<string, UiLabels> = {
  ...
  "lp-vt": {
    play: "Bắt đầu",        pause: "Tạm dừng",      reset: "Đặt lại",       resetAll: "Đặt lại tất cả",
    confirm: "Xác nhận?", today: "Hôm nay",      advice: "Lời khuyên",     end: "Kết thúc",           stopped: "Đã dừng",
    editOverlay: "Sửa", deleteOverlay: "Xóa",
    editModal: "Sửa phần",       newStopwatch: "Đồng hồ bấm giờ mới",
    saveBtn: "Lưu",              addBtn: "Thêm",
    fieldTitle: "Tiêu đề",          fieldDuration: "Thời lượng (phút)",
    fieldSection: "Phần",      fieldAdvice: "Thời gian khuyên (1 phút)",
...
export interface SettingsLabels {
  ...
  showNotesName: string;
  showNotesDesc: string;
  // Alerts section
...
export const LOCALE_SETTINGS: Record<string, SettingsLabels> = {
  "lp-e": {
    ...
    showNotesName: "Show part notes",
    showNotesDesc: "Show a text field on each card to add notes or comments per part.",
  ...
  "lp-s": {
    ...
    showNotesName: "Mostrar notas de parte",
    showNotesDesc: "Mostrar un campo de texto en cada tarjeta para añadir notas o comentarios por parte.",
  ...
  "lp-f": {
    ...
    autoNextPartDesc: "Lors de la mise en pause d'une partie, démarre automatiquement la suivante dans la même section.",
    showNotesName: "Afficher les notes de partie",
    showNotesDesc: "Afficher un champ de texte sur chaque carte pour ajouter des notes ou commentaires par partie.",    alertsHeading: "Alertes",
  ...
  "lp-t": {
    ...
    showNotesName: "Mostrar notas de parte",
    showNotesDesc: "Mostrar um campo de texto em cada cartão para adicionar notas ou comentários por parte.",
    alertsHeading: "Alertas",
  ...
  "lp-x": {
    ...
    showNotesName: "Teilnotizen anzeigen",
    showNotesDesc: "Ein Textfeld auf jeder Karte anzeigen, um Notizen oder Kommentare pro Teil hinzuzufügen.",
  ...
  "lp-i": {
    ...
    showNotesName: "Mostra note della parte",
    showNotesDesc: "Mostra un campo di testo su ogni scheda per aggiungere note o commenti per parte.",
  ...
  "lp-u": {
    ...
    showNotesName: "Показывать заметки части",
    showNotesDesc: "Показывать текстовое поле на каждой карточке для заметок или комментариев к части.",
  ...
  "lp-m": {
    ...
    showNotesName: "Afișează notele părții",
    showNotesDesc: "Afișează un câmp de text pe fiecare card pentru a adăuga note sau comentarii per parte.",
  ...
  "lp-bl": {
    ...
    showNotesName: "Показване на бележки за частта",
    showNotesDesc: "Показва текстово поле на всяка карта за добавяне на бележки или коментари за всяка част.",
  ...
  "lp-o": {
    ...
    showNotesName: "Notities per onderdeel tonen",
    showNotesDesc: "Toon een tekstveld op elke kaart om notities of opmerkingen per onderdeel toe te voegen.",
  ...
  "lp-p": {
    ...
    showNotesName: "Pokaż notatki części",
    showNotesDesc: "Pokaż pole tekstowe na każdej karcie, aby dodawać notatki lub komentarze do każdej części.",
  ...
  "lp-j": {
    ...
    showNotesName: "パートのメモを表示",
    showNotesDesc: "各カードにテキストフィールドを表示してパートごとにメモやコメントを追加できます。",
    alertsHeading: "アラート",
  ...
  "lp-ko": {
    ...
    showNotesName: "파트 메모 표시",
    showNotesDesc: "각 카드에 텍스트 필드를 표시하여 파트별 메모나 댓글을 추가할 수 있습니다.",
    alertsHeading: "알림",
  ...
  "lp-a": {
    ...
    showNotesName: "عرض ملاحظات الجزء",
    showNotesDesc: "عرض حقل نصي على كل بطاقة لإضافة ملاحظات أو تعليقات لكل جزء.",
  ...
  "lp-z": {
    ...
    showNotesName: "Visa anteckningsfält",
    showNotesDesc: "Visa ett textfält på varje kort för att lägga till anteckningar eller kommentarer per del.",
  ...
  "lp-tk": {
    ...
    showNotesName: "Bölüm notlarını göster",
    showNotesDesc: "Her bölüm için not veya yorum eklemek üzere her kartta bir metin alanı göster.",
  ...
  "lp-vt": {
    pageTitle: "JW Meeting Timer — Cài đặt",
    langName: "Ngôn ngữ chương trình nhóm họp",
    langDesc: "Ngôn ngữ được dùng để lấy chương trình hằng tuần từ wol.jw.org.",
    customLocaleName: "Tùy chỉnh locale (nâng cao)",
    customLocaleDesc: 'Thay thế bằng đường dẫn WOL bất kỳ, ví dụ: "r4/lp-s". Để trống nếu dùng danh sách thả xuống.',
    startTimeName: "Giờ bắt đầu nhóm họp",
    startTimeDesc: 'Định dạng 24 giờ, ví dụ: "20:00" hoặc "18:30".',
    openingSongName: "Bài hát mở đầu + cầu nguyện (phút)",
    openingSongDesc: "Số phút cố định trước phần chương trình đầu tiên (bài hát + cầu nguyện). Mặc định: 5.",
    displayHeading: "Hiển thị",
    showAdviceName: "Hiển thị bộ hẹn giờ cho lời khuyên",
    showAdviceDesc: "Hiển thị thẻ phụ 1 phút dành cho lời khuyên của anh chủ tọa bên dưới những phần thích hợp.",
    autoNextPartName: "Tự động bắt đầu bài kế tiếp",
    autoNextPartDesc: "Khi tạm dừng một bài, tự động bắt đầu bài kế tiếp trong cùng một mục.",
    showNotesName: "Hiển thị trường ghi chú",
    showNotesDesc: "Hiển thị một trường ghi chú trên mỗi thẻ để thêm ghi chú hoặc nhận xét cho từng bài.",
    alertsHeading: "Cảnh báo",
    soundAlertName: "Cảnh báo bằng âm thanh khi quá giờ",
    soundAlertDesc: "Phát âm thanh lặp lại khi bộ hẹn giờ đạt đến thời lượng quy định.",
    soundDurName: "Thời lượng cảnh báo âm thanh (giây)",
    soundDurDesc: "Thời gian phát âm thanh. Mặc định: 1 giây.",
    vibrateAlertName: "Cảnh báo rung khi quá giờ",
    vibrateAlertDesc: "Làm thiết bị rung khi bộ hẹn giờ đạt đến thời lượng được quy định. Chỉ dành cho thiết bị di động.",
    vibrateDurName: "Thời lượng cảnh báo rung (giây)",
    vibrateDurDesc: "Thời gian thiết bị rung. Chỉ dành cho thiết bị di động. Mặc định: 2 giây.",
    clearCacheName: "Xóa bộ nhớ đệm chương trình",
    clearCacheDesc: "Xóa tất cả chương trình hằng tuần đã tải về. Hữu ích khi xử lý lỗi. Chương trình sẽ được tải lại vào lần mở sau.",
    clearCacheBtnLabel: "Xóa bộ nhớ đệm",
  },
  "lp-chs": {
    ...
    showNotesName: "显示备注字段",
    showNotesDesc: "在每张卡片上显示文本字段，以便为每个部分添加备注或评论。",
    alertsHeading: "提醒",
